...
contains
    ...
    subroutine kick2t_BeamBunch(innp,incurr,innx,inny,innz,rays,exg,&
                                ...
                                fldmap,flagerr, debug_particle)!add beam current incurr 2016-2-10
        implicit none
        include 'mpif.h'
        ...
        do n = 1, innp
            if(rays(5,n)>0) then !//only particles outside the emission plane get accelerated
                ...
                if (n == debug_particle) then
                    ...
                    print *, '        upy: ', upy
                    print *, '        upz: ', upz
                    print *, '  rays(2,n): ', rays(2,n)
                    print *, '  rays(4,n): ', rays(4,n)
                    print *, '  rays(6,n): ', rays(6,n)
                    print *, '------------------END DEBUGGING------------------'
